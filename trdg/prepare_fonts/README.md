...
On the tested machine, the first script took about 20 minutes, the second script took about 65 minutes, the third script was very quick. In total, the expected executation time ranges from 70 minutes to 90 minutes. The execution time of the first command partly depends on internet connection. 
